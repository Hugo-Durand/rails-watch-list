...
p "create movie"
test = Movie.new(title: "Wonder Woman 1984", overview: "Wonder Woman comes into conflict with the Soviet Union during the Cold War in the 1980s", poster_url: "https://image.tmdb.org/t/p/original/8UlWHLMpgZm9bx6QYh0NFoq67TZ.jpg", rating: 6.9)
p test.save!
...
p "fini movie"
p "début list"
p List.create(name: "Drama")
p List.create(name: "Comedy")
p "fin list"
